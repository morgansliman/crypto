...
import itertools, re
import videnereCipher, pyperclip, freqAnalysis, detectEnglish
...
def main():
    ciphertext = '''TTxWREA6JiVTKCcpRTxXNUU7JzFPKCY1Uz0mNEA8RjVUO1JYT itCIVQ5MiFRPTY1RDgyIU05NllPPFIhUA0KRzg3KUEoJlFMOTY9QT xCIUEoJlFBKCY5STtGJUwoJjVOKCYtWThGNVI4ViVNPCJgUiwjJF UNCmA='''
...
def getMostCommonFactors(seqFactors):
    ...
    # 18, 23, 36, 46, 69, 92, 138, 207], 'ALW': [2, 3, 4, 5, ...], ...}
...
def kasiskiExamination(ciphertext):
    ...
    # in the cihertext. repeatedSeqSpacings has a value like:
...
def attemptHackWithKeyLength(ciphertext, mostLikelyKeyLength):
    ...
    for nth in range(1, mostLikelyKeyLength + 1):
        ...
        for possibleKey in LETTERS:
            decryptedText = videnereCipher.decryptMessage(possibleKey, nthLetters)
    ...
    for indexes in itertools.product(range(NUM_MOST_FREQ_LETTERS), repeat=mostLikelyKeyLength):
        ...
        decryptedText = videnereCipher.decryptMessage(possibleKey, ciphertextUp)
