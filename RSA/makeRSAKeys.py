...
import random, sys, os, primeMod, cryptomath


def main():
    # create a public/priate keypair with 1024 bit keys
...
def generateKey(keySize):
    ...
    p = primeMod.generateLargePrime(keySize)
    print('Generating q prime...')
    q = primeMod.generateLargePrime(keySize)
    n = p * q
